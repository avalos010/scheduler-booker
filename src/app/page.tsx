          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Intelligent calendar management with customizable working hours
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Flexible time slot configuration with customizable durations and
                break management.
              </p>
            </div>
            ...
            <div className="text-center p-8 bg-white rounded-2xl shadow-lg border border-gray-100">
              ...
              <p className="text-gray-600">
                Seamless client booking experience with automated confirmations
                and reminders.
              </p>
            </div>
          </div>
      ...
      <footer className="px-6 py-12 bg-gray-900 text-gray-400">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-sm mb-4">
            © {new Date().getFullYear()} Scheduler Booker. All rights reserved.
          </p>
